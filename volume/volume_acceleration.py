...
from helpers.regression_helpers import check_covariance, multi_match, check_assumptions
...
#TODO: LOTS OF DECISIONS/TODOS LEFT WITH THIS ONE,
# %%
# =============================================================================
...
if RLD == False:
    # Match
    regressors_matched = multi_match(
            df=regressors_clean,
...
sns.lineplot(data=gdf, x="age_group", y=feat,
         ...
         marker="o", linewidth=4*lw, markersize=10*lw, err_kws={"capsize": 6*lw,
                                                         "capthick": 4*lw,
                                                         "elinewidth": 4*lw},
...
# Title
plt.title("Gray matter atrophy across age and T2DM disease progression:\n" \
