...
suffix1 = f"batch{BATCH}_GM_{GM_THR}_contrast_sex"
cmap = "bwr_r"
vm = 8
...
display = plotting.plot_roi(fore, cmap=cmap, cut_coords=cut_coords,
...
plt.savefig(OUTDIR + f'figures/JAMA_meta_neurofunction_{MDL}_sex_hc_overlap.pdf',
            transparent=True)
